...
# Neo4j Aura and HERE credentials come from the environment (see .env.example).
NEO4J_URI = os.getenv("NEO4J_URI", "neo4j+s://XXXXXX.databases.neo4j.io")
NEO4J_USER = os.getenv("NEO4J_USER", "neo4j")
NEO4J_PASSWORD = os.getenv("NEO4J_PASSWORD", "XXXXXX")

HERE_API_KEY = os.getenv("HERE_API_KEY", "XXXXXX")
